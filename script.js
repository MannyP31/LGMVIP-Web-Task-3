...
function readFormData(){
    ...
    formData["studCode"] = document.getElementById("studCode").value;
...
function resetForm(){
    ...
    document.getElementById('studCode').value = '';
...
function onEdit(td){
    ...
    document.getElementById('studCode').value = selectedRow.cells[1].innerHTML;
    document.getElementById('gender').value = selectedRow.cells[2].innerHTML;
    document.getElementById('city').value = selectedRow.cells[3].innerHTML;
}
function updateRecord(formData){
    selectedRow.cells[0].innerHTML = formData.fullName;
    selectedRow.cells[1].innerHTML = formData.studCode;
